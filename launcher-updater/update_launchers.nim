# Update the lauchers in /usr/share/denios-menu/applications
# Copy launchers from denios-menu (/usr/share/denios-menu/applications) to dest folder if it was installed
#   1. Check package name from X-Denios-Package=
